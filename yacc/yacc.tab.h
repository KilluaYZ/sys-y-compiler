...
# define YYTOKENTYPE
  enum yytokentype
  {
    ...
    T_NOT = 278,                   /* T_NOT  */
    T_BOOL_TRUE = 279,             /* T_BOOL_TRUE  */
    T_BOOL_FALSE = 280,            /* T_BOOL_FALSE  */
    T_DELIMITER = 281,             /* T_DELIMITER  */
    T_NEWLINE = 282,               /* T_NEWLINE  */
    T_ERRORCHAR = 283,             /* T_ERRORCHAR  */
    T_IDENT = 284,                 /* T_IDENT  */
    T_COMMA = 285,                 /* T_COMMA  */
    T_INTEGER_CONST = 286,         /* T_INTEGER_CONST  */
    T_HEX_CONST = 287,             /* T_HEX_CONST  */
    T_DEC_CONST = 288,             /* T_DEC_CONST  */
    T_OCT_CONST = 289,             /* T_OCT_CONST  */
    T_ADD = 290,                   /* T_ADD  */
    T_SUB = 291,                   /* T_SUB  */
    T_MUL = 292,                   /* T_MUL  */
    T_DIV = 293,                   /* T_DIV  */
